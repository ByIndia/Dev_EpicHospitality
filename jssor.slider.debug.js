    ...
    $Jssor$ = window.$Jssor$ = new function() {
        ...
        function Ab() {
            if (!D) {
                ...
                var a;
                if (u.pointerEnabled || (a = u.msPointerEnabled)) D.$TouchActionAttr = a ? "msTouchAction" : "touchAction"
            }
            return D
        }
        ...
        function X() {
            return cb() && r > 534 && r < 535
        }

        function y() {
            m();
            return r > 537 || c > 42 || j == C && c >= 11
        }
        ...
        function w(a) {
            return a == null ? String(a) : xb()[lb(a)] || "object"
        }
        ...
        b.$Device = Ab;
        b.$IsBrowserIE = i;
        b.$IsBrowserIeQuirks = K;
        b.$IsBrowserFireFox = sb;
        b.$IsBrowserSafari = cb;
        b.$IsBrowserChrome = vb;
        b.$IsBrowserOpera = hb;
        b.$IsBrowserBadTransform = X;
        b.$IsBrowser3dSafe = y;
        b.$IsBrowserIe9Earlier = I;
        b.$GetTransformProperty = Y("transform");
        ...
        function S(a) {
            a.constructor === S.caller && a.$Construct && a.$Construct.apply(a, S.caller.arguments)
        }
        b.$Construct = S;
        ...
        b.$CssScale = function(a, b) {
            if (i() && k < 9 || k < 10 && K()) a.style.zoom = b == 1 ? "" : b;
            else {
                var c = E(a),
                    f = "scale(" + b + ")",
                    e = a.style[c],
        ...
        b.$WindowResizeFilter = function(b, a) {
            return I() ? function() {
                var f = true,
                    c = K() ? b.document.body : b.document.documentElement;
                if (c) {
                    var e = c.offsetWidth - gb,
                        d = c.offsetHeight - bb;
                    if (e || d) {
                        gb += e;
                        bb += d
        ...
        function n(h, k) {
            ...
            n = function(g, f) {
                ...
                if (!c) {
                    i != undefined && b.$CssLeft(g, f.$OriginalX + i);
                    j != undefined && b.$CssTop(g, f.$OriginalY + j)
                }
                if (f.$Transform)
                    if (d) pb(b.$CreateCallback(null, G, g, f));
                    else a(g, f)
            };
            b.$SetStyleTransform = G;
        ...
        b.$Cast = function(f, g, q, h, s, t, i) {
            ...
            if (f) {
                ...
                for (var c in g) {
                    ...
                    var o = Math.floor(b);
                    if (b != o) b -= o;
                    var d = h.$Default || $JssorEasing$.$EaseSwing,
                        e, v = f[c],
                        k = g[c];
                    if ($Jssor$.$IsNumeric(k)) {
                        d = h[c] || d;
                        var r = d(b);
                        e = v + k * r
                    } else {
                        ...
                        $Jssor$.$Each(k.$Offset || k, function(g, a) {
                            if (h.$Clip) d = h.$Clip[a] || h.$Clip.$Default || d;
                            var f = d(b),
                                c = g * f;
                            e.$Offset[a] = c;
                            e[a] += c
            ...
            if (a.$Clip && $Jssor$.$CanClearClip() && !a.$Clip.$Top && !a.$Clip.$Left && a.$Clip.$Right == i.$OriginalWidth && a.$Clip.$Bottom == i.$OriginalHeight) a.$Clip = null;
            return a
        }
    };
...
var $JssorSlideshowFormations$ = window.$JssorSlideshowFormations$ = new function() {
    ...
    $JssorSlider$ = window.$JssorSlider$ = function(c, Xb) {
        ...
        var I = !a.$UISearchMode,
            k, g = $Jssor$.$FindChild(c, "slides", I),
            N = $Jssor$.$FindChild(c, "loading", I) || $Jssor$.$CreateDiv(document),
            eb = $Jssor$.$FindChild(c, "navigator", I),
            wb = $Jssor$.$FindChild(c, "arrowleft", I),
            ub = $Jssor$.$FindChild(c, "arrowright", I),
            db = $Jssor$.$FindChild(c, "thumbnavigator", I);
        $JssorDebug$.$Execute(function() {
        ...
        var ec = 0,
            ...
            h = Math.min(a.$Cols, d),
            V, j, z, rb, K = [],
            Lb, Nb, Jb, Vb, vc, F, q = a.$PauseOnHover,
        ...
        q &= X ? 10 : 5;
        if (eb && G) {
            Lb = new G.$Class(eb, G, O(), W());
            K.push(Lb)
        }
        if (u && wb && ub) {
            u.$Loop = p;
            u.$Cols = h;
            Nb = new u.$Class(wb, ub, u, O(), W());
            K.push(Nb)
        }
        if (db && A) {
